...
public class AuthService : IAuthService
{
    ...
    public AuthService(IBaseRepository<User> userRepository, ILogger logger, IMapper mapper, IBaseRepository<UserToken> userTokenRepository, ITokenService tokenService, IBaseRepository<Role> roleTokenRepository, IUnitOfWork unitOfWork)
    {
        ...
        _roleRepository = roleTokenRepository;
